...
export default function DropDown({ mealType }) {
    ...
    const handleRemoveMeal = () => {
        ...
        localStorage.removeItem(
            mealType === 'Lunch' ? 'selectedLunch' : 'selectedDinner'
        )
    }
        ...
        <>
            <Dropdown>
                ...
                >
                    ...
                    <DropdownItem
                        onClick={() => {
                            handleGenerateRandomMeal()
                            setTime((prevDisplay) => prevDisplay)
                        }}
                    >
            ...
            {!localSelectedMeal && (
                <Button
                    ...
                    aria-label={`Add ${mealType} Meal`}
                >
                    <p className="weekPlanTextrutaa">Generera slumpad måltid</p>
                </Button>
            )}

            {localSelectedMeal && (
                <Button
                    className="weekPlanDelete"
                    variant="contained"
                    onClick={() => {
                        handleRemoveMeal()
                        setTime((prevDisplay) => prevDisplay)
