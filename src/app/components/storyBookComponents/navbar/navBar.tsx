        ...
        <>
            <div className='navContainer'>
                <nav className='navBar'>
                    ...
                    <Link href="/planning">
                        <span className={(pathname === "/planning" ? "active" : "navButton")} id='navPlanning'>
                    ...
                    <Link href="/create">
                        <span className={(pathname === "/create" ? "navAddActive" : "navAdd")} id='navAdd'>
                    ...
                    <Link href="/history">
                        <span className={(pathname === "/history" ? "active" : "navButton")} id='navHistory'>
                    ...
                    <Link href="/profile/stats">
                        <span className={(pathname === "/profile/stats" ? "active" : "navButton")} id='navProfile'>
