...
export default async function History({ params: { lng } }) {
    ...
    return (
        ...
        <div className={styles.prison}>
            ...
            <div className={styles.undertext}><p>{t('glossary:add_saved')}</p></div>

            <div className={styles.tabort}>
                <div id={styles.flex}>
                    <div>
                        <div className={styles.textTitle}><h3>{t('common:ingredients')}</h3></div>
                    ...
                    <div>
                        <div className={styles.textTitle2}><h3>{t('common:instructions')}</h3></div>
