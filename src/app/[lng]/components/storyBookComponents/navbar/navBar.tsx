...
export const NavBar = async ({ lng, session }: { lng: string, session: Session | null }) => {
            ...
            <>
                <div className='navContainer'>
                    <nav className='navBar'>
                        ...
                        <Link href={`/${lng}`}>
                            <span className={(pathname === `/${lng}` ? "active" : "navButton")} id='navHome'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 1792 1792" id="home"><path d="M1472 992v480q0 26-19 45t-45 19h-384v-384H768v384H384q-26 0-45-19t-19-45V992q0-1 .5-3t.5-3l575-474 575 474q1 2 1 6zm223-69-62 74q-8 9-21 11h-3q-13 0-21-7L896 424l-692 577q-12 8-24 7-13-2-21-11l-62-74q-8-10-7-23.5t11-21.5l719-599q32-26 76-26t76 26l244 204V288q0-14 9-23t23-9h192q14 0 23 9t9 23v408l219 182q10 8 11 21.5t-7 23.5z" id='scale'></path></svg>
                                <p>{t('common:navbar.home')}</p>
                            </span>
                        </Link>

                        <Link href={`/${lng}/planning`}>
                            <span className={(pathname === `/${lng}/planning` ? "active" : "navButton")} id='navPlanning'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24" id="fork"><path d="M16.84,11.63A3,3,0,0,0,19,10.75l2.83-2.83a1,1,0,0,0,0-1.41,1,1,0,0,0-1.42,0L17.55,9.33a1,1,0,0,1-1.42,0h0L19.67,5.8a1,1,0,1,0-1.42-1.42L14.72,7.92a1,1,0,0,1,0-1.41l2.83-2.83a1,1,0,1,0-1.42-1.42L13.3,5.09a3,3,0,0,0,0,4.24h0L12,10.62,3.73,2.32l-.1-.06a.71.71,0,0,0-.17-.11l-.18-.07L3.16,2H3.09l-.2,0a.57.57,0,0,0-.18,0,.7.7,0,0,0-.17.09l-.16.1-.07,0-.06.1a1,1,0,0,0-.11.17,1.07,1.07,0,0,0-.07.19s0,.07,0,.11a11,11,0,0,0,3.11,9.34l2.64,2.63-5.41,5.4a1,1,0,0,0,0,1.42,1,1,0,0,0,.71.29,1,1,0,0,0,.71-.29L9.9,15.57h0l2.83-2.83h0l2-2A3,3,0,0,0,16.84,11.63ZM9.19,13.45,6.56,10.81A9.06,9.06,0,0,1,4,5.4L10.61,12Zm6.24.57A1,1,0,0,0,14,15.44l6.3,6.3A1,1,0,0,0,21,22a1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.42Z"></path></svg>
                                <p>{t('common:navbar.plan')}</p>
                            </span>
                        </Link>

                        <Link href={`/${lng}/create`}>
                            <span className={(pathname === `/${lng}/create` ? "navAddActive" : "navAdd")} id='navAdd'>
